...
- [EDUCATI E FINANZIATI](#educati-e-finanziati)
  - [EEF 02 - Strategia di investimento a quattro pilastri](#eef-02---strategia-di-investimento-a-quattro-pilastri)
    - [Liquidità per le spese quotidiane](#liquidità-per-le-spese-quotidiane)
    - [Spese di emergenza](#spese-di-emergenza)
    - [Spese prevedibili - previste](#spese-prevedibili---previste)
    - [Lungo termine](#lungo-termine)
    - [Obiettivi](#obiettivi)
  - [EEF 03 - Scegliere il conto corrente](#eef-03---scegliere-il-conto-corrente)
  - [EEF 04 - Ti serve una carta di credito?](#eef-04---ti-serve-una-carta-di-credito)
    - [Bancomat - carta di debito](#bancomat---carta-di-debito)
    - [Carta di credito](#carta-di-credito)
    - [Carta ricaricabile](#carta-ricaricabile)
  - [EEF 05 - Scegliere il giusto conto titoli](#eef-05---scegliere-il-giusto-conto-titoli)
  - [EEF 06 - La matematica necessaria](#eef-06---la-matematica-necessaria)
    - [Interesse composto](#interesse-composto)
    - [Annualizzare l'interesse](#annualizzare-linteresse)
    - [Tasso Interno di Rendimento](#tasso-interno-di-rendimento)
    - [Statistica descrittiva](#statistica-descrittiva)
  - [EEF 07 - Investimenti a brevissimo termine - conto deposito](#eef-07---investimenti-a-brevissimo-termine---conto-deposito)
    - [Conto corrente](#conto-corrente)
    - [Conto deposito](#conto-deposito)
    - [Obbligazioni a brevissima durata](#obbligazioni-a-brevissima-durata)
    - [ETF monetari](#etf-monetari)
  - [EEF 08 - investimenti a medio termine - le obbligazioni](#eef-08---investimenti-a-medio-termine---le-obbligazioni)
    - [Plain vanilla - TF](#plain-vanilla---tf)
    - [Step Up](#step-up)
    - [Cedola completamente variabile](#cedola-completamente-variabile)
    - [Zero coupon - ZC](#zero-coupon---zc)
    - [Calcolo del prezzo di una obbligazione](#calcolo-del-prezzo-di-una-obbligazione)
  - [EEF 09 - Come acquistare una obbligazione](#eef-09---come-acquistare-una-obbligazione)
...
Rilasciata necessariamente dalla propria banca (molto spesso gratuitamente), si appoggia al circuito _Pagomancomat_ per effettuare pagamenti; se è anche _Maestro_ allora può essere utilizzata per alcuni pagamenti online.
...
|          | guadagno _(b-a)_    | 100      |     | guadagno   | 100,00  |
|          | gain _(b-a)/a_      | 57,4911% |     | gain       | 0,0100% |
|          | _(b/a)-1_           | 57,4911% |     |            | 0,0100% |
| RITORNO  | 57,5%               |          |     |            |         |
| 1/1/2027 | 328,728 _(b+b+20%)_ |          |     |            |         |
|          | guadagno            | 88,989%  |     |            |         |
...
## EEF 07 - Investimenti a brevissimo termine - conto deposito

Dove mettere il fondo di emergenza (secondo pilastro)? Cuscinetto per spese non previste e non prevedibili. Una volta deciso quanto metterci bisogna decidere dove.

### Conto corrente

Tendenzialmente non danno interessi. Se danno interessi, il guadagno è tassato al 26%. Capitale garantito fino a 100.000€.
...
Rendimento più o meno in linea con i tassi di mercato, ma di un mercato molto controllato. Tassati al 26% più il bollo dello 0,2% su quanto c'è sul conto al 31/12.
...
Il rischio più grosso è che l'azienda fallisca / che il governo non paghi le cedole e/o il capitale iniziale. Le agenzie di rating (moody's, S&P, etc...) valutano l'affidabilità di governi e aziende.

Il rendimento si calcola con il [*TIR*](#tasso-interno-di-rendimento).

Nei *BTP*, titoli di stato emessi dal governo italiano, la cedola è pagata semestralmente.
...
## EEF 09 - Come acquistare una obbligazione

[Simple tools for investors](https://www.simpletoolsforinvestors.eu/index.shtml)

### Microstruttura del mercato finanziario
Meccanismo per inserire gli ordini all'interno del mercato finanziario.
...
*Rateo* --> quando si acquista una obbligazione bisogna pagare al proprietario precedente il pezzo di cedola che ha maturato dal giorno dopo il pagamento dell'ultima cedola al momento del mio acquisto.
*Ritenuta rateo* --> la cedola viene tassata totalmente, la rit. rateo è la porzione di tassa che deve pagare il precedente proprietario sull'ultima cedola.

Per questo motivo è meglio evitare di comprare obbligazioni che stanno per pagare la cedola, matematicamente i soldi rientrano al pagamento della cedola successiva, ma magari nel frattempo sono passati mesi.
